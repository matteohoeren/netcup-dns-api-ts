...
| `5031` | Server/processing error | Getting DNS zone failed. Domain may not exist in the account or the domain is ordered but still in transfer.                                                                                                                | Verify the domain exists in your Netcup account and uses Netcup Nameserver. If the domain was recently ordered, wait for the transfer to complete. Check `longmessage` for specifics. |
